...
export const cards = [
  ...
  },
  {
    ...
    text: 'Context, HOC, hooks', link: 'https://checkin.ben.bg', image: Checkin, width: 450, class: 'animated-text-stripOneCardTitle'
  },
  {
    id: 'Task Drag',
    title: 'Task Drag Organizer ',
    text: 'Redux, hooks', link: 'https://www.dnd.ben.bg', image: Dnd, width: '', class: 'animated-text-stripOneCardTitle'
  },
  {
    id: 'ТЕХНОЛОГИЯ',
    title: 'ТЕХНОЛОГИЯ',
