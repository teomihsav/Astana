export const en = {
  "frontText": {
    ...
    "two": "The fun - Sofia :). Focused on creating interactive digital experiences on the web.",
    "three": "Has experience with many technologies and libraries.",
    "four": "Working with new startups and big brands.",
  },

  "Checkin": {
    "Checkin": "Checkin Car Rental",
    "title": "A rental car registration app to completely fill in missing data and add credit card and additional drivers.",
